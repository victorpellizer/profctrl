        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Editar Função do Docente</li>
                </ol>
            </nav>
            ...
            <div class="card">
                    <div class="card-body">
                        <h3>Função do Docente - {{$docente->nomeDocente}}</h3>
                        <hr>
...
@method('PUT')
    ...
    <select class="form-control @error('funcao') is-invalid @enderror"  style="width: 200px" name="funcao" >
        ...
        <option value="2" {{$docente->funcao=="Docência no AEE" ? 'selected' : ''}}>Docência no AEE</option>
        <option value="3" {{$docente->funcao=="Direção de instituição educacional" ? 'selected' : ''}}>Direção de instituição educacional</option>
        <option value="4" {{$docente->funcao=="Direção aux de instituição educacional" ? 'selected' : ''}}>Direção auxiliar de instituição educacional</option>
        <option value="5" {{$docente->funcao=="Coordenação pedagógica" ? 'selected' : ''}}>Coordenação pedagógica</option>
        <option value="6" {{$docente->funcao=="Coordenação educacional" ? 'selected' : ''}}>Coordenação educacional</option>
    </select>
    <br>
