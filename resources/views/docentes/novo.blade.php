                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{action('DocenteController@store')}}">
                        ...
                        <div class="form-group row">
                            <label for="nomeDocente" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right"
                                title="Nome do Docente. O nome deve conter somente letras de a-z e A-Z.">Nome:</label>
                            <div class="col-md-6">
                                <input id="nomeDocente" type="text"
                                    class="form-control @error('nomeDocente') is-invalid @enderror" name="nomeDocente"
                                    value="" required autocomplete="nomeDocente" autofocus placeholder="Nome Completo">
                                @error('nomeDocente')
                                <span class="invalid-feedback" role="alert">
                                    <strong>Nome inválido. Tente novamente digitando apenas letras de a-z e
                                        A-Z.</strong>
                                </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right"
                                title="Número de matricula do Docente de 6 a 7 digitos.">Matrícula:</label>
                            <div class="col-md-2">
                                <input id="field" type="number"
                                    class="form-control @error('matricula') is-invalid @enderror" name="matricula"
                                    value="{{ old('matricula') }}" autofocus placeholder="0000000">
                                @error('matricula')
                                <span class="invalid-feedback" role="alert">
                                    <strong>Número de Matrícula inválido. A matrícula deve conter de 6 a 7
                                        digitos.</strong>
                                </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right"
                                title="Quantidade de Pontos de Desempenho do Docente (Menor que 100)">Pontos de
                                Desempenho:</label>
                            <div class="col-md-2">
                                <input id="pontosDeDesempenho" type="number"
                                    class="form-control @error('pontosDeDesempenho') is-invalid @enderror"
                                    name="pontosDeDesempenho" value="{{ old('pontosDeDesempenho') }}" autofocus
                                    placeholder="0">
                        ...
                        <div class="form-group row">
                            <label for="cargo" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right" title="Cargo que o Docente ocupa.">Cargo:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="funcao" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right" title="Função que o Docente exerce.">Função:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="lotacao" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right"
                                title="Instituição em que o Docente está lotado.">Lotação:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="nivel" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right" title="Nível do Docente (Elevação vertical).">Nivel:</label>
                        ...
                        <div class="form-group row">
                            <label for="classe" class="col-md-4 col-form-label text-md-right" data-toggle="tooltip"
                                data-placement="right" title="Classe do Docente (Elevação Horizontal).">Classe:</label>
                            <div class="col-md-2">
                                <select id="classe" class="form-control @error('classe') is-invalid @enderror"
                                    style="width: 80px" name="classe">
                        ...
                        <div class="form-group row">
                            <label for="cargaHoraria" class="col-md-4 col-form-label text-md-right"
                                data-toggle="tooltip" data-placement="right"
                                title="Carga Horaria do cargo do Docente em horas semanais.">Carga Horaria:</label>

                            <div class="col-md-2">
                                <select class="form-control @error('cargaHoraria') is-invalid @enderror"
                                    style="width: 200px" name="cargaHoraria">
                        ...
                        <div class="form-group row">
                            <label for="tempoDeServico" class="col-md-4 col-form-label text-md-right"
                                data-toggle="tooltip" data-placement="right"
                                title="Benefício de Tempo de Serviço em porcentagem (%).">Tempo De Servico (%):</label>

                            <div class="col-md-2">
                                <select class="form-control @error('tempoDeServico') is-invalid @enderror"
                                    name="tempoDeServico" style="width: 200px">
...
-->
                        ...
                        <div class="form-group row">
                            <label for="valorGratificacao" class="col-md-4 col-form-label text-md-right"
                                data-toggle="tooltip" data-placement="right"
                                title="Benefício de Gratificação em Reais (R$).">Gratificação (R$):</label>
...
-->
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-info" href="{{action('DocenteController@index')}}">Voltar <i
