        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    @if(isset($docentes))
                        <h3>Progressão de Carreira <i class="fa fa-info-circle btn btn-secundary" style="float: right" data-toggle="tooltip" data-placement="top" title="Aqui estão as informações de progressão de carreira dos docentes, você pode navegar facilmente por todos eles e selecioná-los para edição."></i></h3>
                        ...
                        100%">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-toggle="tooltip" data-placement="top" title="Nível do Docente (A-D).">Nível</th>
                                    <th scope="col" data-toggle="tooltip" data-placement="top" title="Classe do Docente (1-15).">Classe</th>
                                    <th scope="col" data-toggle="tooltip" data-placement="top" title="Instituição em que o Docente está lotado.">Lotação</th>
                                    
                                    <th scope="col"data-toggle="tooltip" data-placement="top" title="Remuneração do Docente, composta por Salário, Tempo de Serviço, Gratificação e Deslocamento.">Remuneração</th>
                                    <!--
                                   ...
                                   -->
                                   <th scope="col" data-toggle="tooltip" data-placement="top" title="Status do Docente.">Status</th>
                                </tr>
                            </thead>
