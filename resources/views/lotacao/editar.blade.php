        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Editar Lotação do Docente</li>
                </ol>
            </nav>
            ...
            <div class="card">
                    <div class="card-body">
                        <h3>Lotação do Docente - {{$docente->nomeDocente}}</h3>
                        <hr>
...
@method('PUT')
    ...
    <select class="form-control @error('lotacao') is-invalid @enderror"  style="width: 200px" name="lotacao" >
        <option value="15" {{$docente->lotacao=="Sem Lotação" ? 'selected' : ''}}>Sem Lotação</option>   
        <option value="1" {{$docente->lotacao=="Betânia" ? 'selected' : ''}}>Betânia</option>
        <option value="2" {{$docente->lotacao=="Tônia Harms" ? 'selected' : ''}}>Tônia Harms</option>
        <option value="3" {{$docente->lotacao=="Geralda Harms" ? 'selected' : ''}}>Geralda Harms</option>
        <option value="4" {{$docente->lotacao=="Fátima A. Bosa" ? 'selected' : ''}}>Fátima A. Bosa</option>
        <option value="5" {{$docente->lotacao=="Canaã" ? 'selected' : ''}}>Canaã</option>
        <option value="6" {{$docente->lotacao=="Limpo Grande" ? 'selected' : ''}}>Limpo Grande</option>
        <option value="7" {{$docente->lotacao=="São Judas Tadeu" ? 'selected' : ''}}>São Judas Tadeu</option>
        <option value="8" {{$docente->lotacao=="José P. N. Rosas" ? 'selected' : ''}}>José P. N. Rosas</option>
        <option value="9" {{$docente->lotacao=="SMEC" ? 'selected' : ''}}>SMEC</option>
        <option value="10" {{$docente->lotacao=="Sta Rita de Cássia" ? 'selected' : ''}}>Sta Rita de Cassia</option>
        <option value="11" {{$docente->lotacao=="Theresa G. Seifarth" ? 'selected' : ''}}>Theresa G. Seifarth</option>
        <option value="12" {{$docente->lotacao=="Santa Cruz" ? 'selected' : ''}}>Santa Cruz</option>
        <option value="13" {{$docente->lotacao=="Dep. Alim Esc" ? 'selected' : ''}}>Dep. Alim. Esc</option>
    ...
    <hr>
    <h5>Histórico de alterações nas lotações:</h5>
