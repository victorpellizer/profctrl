    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                ...
                Os valores estão de acordo com a Lei 2132152132 de 2022 de Carambeí/PR.
                <table class="table display responsive no-wrap table-striped" style="width: 600px">
                        <tr>
                            <th scope="col" style="width: 200px" data-toggle="tooltip" data-placement="top" title="Salário base do docente">Salário base</th>
                        ...
                        <tr>
                            <th data-toggle="tooltip" data-placement="top" title="Define a porcentagem do salário base que será o adicional por deslocamento">Adicional de Deslocamento</th>
                        ...
                        <tr>
                            <th data-toggle="tooltip" data-placement="top" title="Regra atual foi inserida">Regra inserida por</th>
                            <td>{{$regra->usuario}} em {{$regra->dataRegra}}</td>
                        </tr>
                    </table>
                    <a class="btn btn-warning border rounded" role="button" href="{{action('RegraController@create')}}">Atualizar regra<i class="fa fa-edit"></i></a>
                        <br>
@endsection
