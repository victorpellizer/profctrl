        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Editar Remuneração do Docente</li>
                </ol>
            </nav>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h3>Editar Remuneração do Docente - {{$docente->nomeDocente}}</h3>
...
<h5>Alteração de Benefícios</h5>
    ...
    <div class="col-md-6">
        ...
        <select class="form-control @error('beneficioG') is-invalid @enderror" name="beneficioG" style="width: 200px">
            ...
            <option value="447.60" {{$docente->beneficioG==447.60 ? 'selected' : ''}}>447,60</option>
            <option value="453.43" {{$docente->beneficioG==453.43 ? 'selected' : ''}}>453,43</option>
            <option value="534.72" {{$docente->beneficioG==534.72 ? 'selected' : ''}}>534,72</option>
            <option value="630.97" {{$docente->beneficioG==630.97 ? 'selected' : ''}}>630,97</option>
            <option value="991.52" {{$docente->beneficioG==991.52 ? 'selected' : ''}}>991,52</option>
            <option value="1171.80" {{$docente->beneficioG==1171.80 ? 'selected' : ''}}>1171,80</option>
            <option value="1288.97" {{$docente->beneficioG==1288.97 ? 'selected' : ''}}>1288,97</option>
            <option value="1352.08" {{$docente->beneficioG==1352.08 ? 'selected' : ''}}>1352,08</option>
            <option value="1532.35" {{$docente->beneficioG==1532.35 ? 'selected' : ''}}>1532,35</option>
        </select>
...
-->
    ...
    <div class="col-md-6">
    Deslocamento (R$): 
<select class="form-control @error('beneficioD') is-invalid @enderror" name="beneficioD" style="width: 200px">
                                <option value="0.00" {{$docente->beneficioD==0.00 ? 'selected' : ''}}>0,00</option>
                                <option value="191.83" {{$docente->beneficioD==191.83 ? 'selected' : ''}}>191,83</option>
                            </select>
                            <!--
