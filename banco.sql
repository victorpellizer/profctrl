...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 15-Set-2019 às 17:58
...
CREATE TABLE IF NOT EXISTS `beneficio` (
  ...
  `dataInicioBeneficio` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `fk_Remuneracao_Usuario1_idx` (`Usuario_idUsuario`),
  KEY `fk_Beneficio_Docente1_idx` (`Docente_idDocente`)
...
INSERT INTO `beneficio` (`idBeneficio`, `dataInicioBeneficio`, `tipoBeneficio`, `valorBeneficio`, `Usuario_idUsuario`, `Docente_idDocente`) VALUES
(1, '2019-09-11 13:15:24', 'S', '2570.31', 1, 1),
(2, '2019-09-11 13:15:24', 'D', '0', 1, 1),
(3, '2019-09-11 13:15:24', 'TS', '890.46', 1, 1),
(4, '2019-09-11 13:15:24', 'G', '991.52', 1, 1),
(5, '2019-09-13 12:34:13', 'S', '1000', 1, 2),
(6, '2019-09-13 12:34:25', 'D', '100', 1, 2),
(7, '2019-09-13 12:34:56', 'TS', '500', 1, 2),
(8, '2019-09-13 12:35:06', 'G', '0', 1, 2),
(9, '2019-09-13 12:59:30', 'S', '400', 1, 3);
...
INSERT INTO `cidade` (`idCidade`, `nomeCidade`, `Estado_idEstado`) VALUES
(1, 'Afonso Cláudio', 8),
...
--
-- Estrutura da tabela `classe_docente`
--

DROP TABLE IF EXISTS `classe_docente`;
CREATE TABLE IF NOT EXISTS `classe_docente` (
  `dataInicioClasse` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Docente_idDocente` int(32) NOT NULL,
  `Classe_idClasse` int(3) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Classe_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Classe_Docente_Classe1_idx` (`Classe_idClasse`),
  KEY `fk_Classe_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `classe_docente`
--

INSERT INTO `classe_docente` (`dataInicioClasse`, `Docente_idDocente`, `Classe_idClasse`, `Usuario_idUsuario`) VALUES
('2019-09-13 13:23:29', 1, 4, 1),
('2019-09-13 13:23:42', 1, 5, 1),
('2019-09-13 13:28:26', 2, 3, 1),
('2019-09-13 13:28:37', 2, 4, 1);
...
INSERT INTO `docente` (`idDocente`, `matricula`, `nomeDocente`, `cargo`, `status`, `pontosDeDesempenho`, `cargaHoraria`, `tempoDeServico`, `Cidade_idCidade`) VALUES
(1, 156101, 'Valdirene Aparecida Rosas', 'Professor', '1', 0, 20, 25, 1),
(2, 24242, 'Gustavo Rosas', 'Docente', '1', 10, 40, 20, 1),
(3, 23332, 'Victor Pellizer', 'Docente', '1', 10, 40, 20, 1);
...
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  `nomeEstado` varchar(75) DEFAULT NULL,
...
INSERT INTO `estado` (`idEstado`, `nomeEstado`, `uf`, `Pais_idPais`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
(1, 'Docencia'),
(2, 'Docencia no AEE'),
(3, 'Direcao de instituicao educacional'),
(4, 'Direcao aux de instituicao educacional'),
(5, 'Coordenacao pedagogica'),
(6, 'Coordenacao educacional');

-- --------------------------------------------------------

--
-- Estrutura da tabela `funcao_docente`
--

DROP TABLE IF EXISTS `funcao_docente`;
CREATE TABLE IF NOT EXISTS `funcao_docente` (
  `dataInicioFuncao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Docente_idDocente` int(32) NOT NULL,
  `Funcao_idFuncao` int(4) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Funcao_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Funcao_Docente_Funcao1_idx` (`Funcao_idFuncao`),
  KEY `fk_Funcao_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `funcao_docente`
--

INSERT INTO `funcao_docente` (`dataInicioFuncao`, `Docente_idDocente`, `Funcao_idFuncao`, `Usuario_idUsuario`) VALUES
('2019-09-11 13:18:27', 1, 1, 1),
('2019-09-13 13:51:26', 2, 4, 1);
...
CREATE TABLE IF NOT EXISTS `instituicao` (
  ...
  `contatoInstituicao` varchar(80) DEFAULT NULL,
...
INSERT INTO `instituicao` (`idInstituicao`, `contatoInstituicao`, `nomeInstituicao`) VALUES
(1, NULL, 'Betânia'),
(2, NULL, 'Segunda escola');
...
CREATE TABLE IF NOT EXISTS `licenca` (
  ...
  `licencaRemunerada` varchar(4) DEFAULT NULL,
...
INSERT INTO `licenca` (`idLicenca`, `tipoLicenca`, `licencaRemunerada`) VALUES
(1, 'Afastamento', '0'),
(2, 'Maternidade', '1'),
(3, 'Atestado', '1');
...
--
-- Estrutura da tabela `licenca_docente`
--

DROP TABLE IF EXISTS `licenca_docente`;
CREATE TABLE IF NOT EXISTS `licenca_docente` (
  `dataInicioLicenca` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Docente_idDocente` int(32) NOT NULL,
  `Licenca_idLicenca` int(32) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Licenca_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Licenca_Docente_Licenca1_idx` (`Licenca_idLicenca`),
  KEY `fk_Licenca_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `licenca_docente`
--

INSERT INTO `licenca_docente` (`dataInicioLicenca`, `Docente_idDocente`, `Licenca_idLicenca`, `Usuario_idUsuario`) VALUES
('2019-09-11 13:19:22', 1, 1, 1),
('2019-09-13 14:31:24', 2, 3, 1),
('2019-09-13 14:31:31', 2, 2, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `lotacao_docente`
--

DROP TABLE IF EXISTS `lotacao_docente`;
CREATE TABLE IF NOT EXISTS `lotacao_docente` (
  `idLotacao_Docente` int(32) NOT NULL,
  `dataInicioLotacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Instituicao_idInstituicao` int(32) NOT NULL,
  `Docente_idDocente` int(32) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Lotacao_Docente_Instituicao1_idx` (`Instituicao_idInstituicao`),
  KEY `fk_Lotacao_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Lotacao_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `lotacao_docente`
--

INSERT INTO `lotacao_docente` (`idLotacao_Docente`, `dataInicioLotacao`, `Instituicao_idInstituicao`, `Docente_idDocente`, `Usuario_idUsuario`) VALUES
(1, '2019-09-13 14:05:24', 1, 1, 1),
(2, '2019-09-13 14:05:24', 1, 2, 1),
(3, '2019-09-13 14:05:39', 2, 1, 1),
(4, '2019-09-13 14:05:39', 2, 1, 1);
...
--
-- Estrutura da tabela `nivel_docente`
--

DROP TABLE IF EXISTS `nivel_docente`;
CREATE TABLE IF NOT EXISTS `nivel_docente` (
  `dataInicioNivel` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Docente_idDocente` int(32) NOT NULL,
  `Nivel_idNivel` int(3) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Nivel_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Nivel_Docente_Nivel1_idx` (`Nivel_idNivel`),
  KEY `fk_Nivel_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `nivel_docente`
--

INSERT INTO `nivel_docente` (`dataInicioNivel`, `Docente_idDocente`, `Nivel_idNivel`, `Usuario_idUsuario`) VALUES
('2019-09-11 13:19:29', 1, 1, 1),
('2019-09-13 14:38:21', 1, 2, 1),
('2019-09-13 14:38:55', 2, 3, 1);
...
CREATE TABLE IF NOT EXISTS `titulo` (
  ...
  `pontosDeFormacao` int(3) DEFAULT '0',
...
INSERT INTO `titulo` (`idTitulo`, `caminho`, `tipoTitulo`, `pontosDeFormacao`) VALUES
(1, 'documentos', 'graduação', 10),
(2, NULL, 'curso', 2);

-- --------------------------------------------------------

--
-- Estrutura da tabela `titulo_docente`
--

DROP TABLE IF EXISTS `titulo_docente`;
CREATE TABLE IF NOT EXISTS `titulo_docente` (
  `dataTitulo` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Titulo_idTitulo` int(32) NOT NULL,
  `Docente_idDocente` int(32) NOT NULL,
  `Usuario_idUsuario` int(4) NOT NULL,
  KEY `fk_Titulo_Docente_Titulo1_idx` (`Titulo_idTitulo`),
  KEY `fk_Titulo_Docente_Docente1_idx` (`Docente_idDocente`),
  KEY `fk_Titulo_Docente_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `titulo_docente`
--

INSERT INTO `titulo_docente` (`dataTitulo`, `Titulo_idTitulo`, `Docente_idDocente`, `Usuario_idUsuario`) VALUES
('2019-09-11 13:19:44', 1, 1, 1),
('2019-09-13 14:45:13', 1, 1, 1),
('2019-09-13 14:45:55', 2, 1, 1);
...
--
-- Stand-in structure for view `vw_classe`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_classe`;
CREATE TABLE IF NOT EXISTS `vw_classe` (
`max(classe_idClasse)` int(3)
,`docente_idDocente` int(32)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `vw_deslocamento`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_deslocamento`;
CREATE TABLE IF NOT EXISTS `vw_deslocamento` (
`max(idBeneficio)` int(10)
,`valorBeneficio` varchar(45)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_funcao`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_funcao`;
CREATE TABLE IF NOT EXISTS `vw_funcao` (
`funcao` varchar(40)
,`max(dataInicioFuncao)` timestamp
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_gratificacao`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_gratificacao`;
CREATE TABLE IF NOT EXISTS `vw_gratificacao` (
`max(idBeneficio)` int(10)
,`valorBeneficio` varchar(45)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_licenca`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_licenca`;
CREATE TABLE IF NOT EXISTS `vw_licenca` (
`nomeDocente` varchar(100)
,`tipoLicenca` varchar(50)
,`Licenca_idLicenca` int(32)
,`Docente_idDocente` int(32)
,`dataInicioLicenca` timestamp
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `vw_lotacao`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_lotacao`;
CREATE TABLE IF NOT EXISTS `vw_lotacao` (
`nomeInstituicao` varchar(150)
,`idLotacao_Docente` int(32)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_nivel`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_nivel`;
CREATE TABLE IF NOT EXISTS `vw_nivel` (
`max(nivel)` varchar(2)
,`max(nivel_idNivel)` int(3)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_salarios`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_salarios`;
CREATE TABLE IF NOT EXISTS `vw_salarios` (
`max(idBeneficio)` int(10)
,`valorBeneficio` varchar(45)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_tempodeservico`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_tempodeservico`;
CREATE TABLE IF NOT EXISTS `vw_tempodeservico` (
`max(idBeneficio)` int(10)
,`valorBeneficio` varchar(45)
,`docente_idDocente` int(32)
);
...
--
-- Stand-in structure for view `vw_titulo`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_titulo`;
CREATE TABLE IF NOT EXISTS `vw_titulo` (
`nomeDocente` varchar(100)
,`tipotitulo` varchar(50)
,`titulo_idtitulo` int(32)
,`Docente_idDocente` int(32)
,`datatitulo` timestamp
);

-- --------------------------------------------------------

--
-- Structure for view `vw_classe`
--
...
--
-- Structure for view `vw_deslocamento`
--
...
--
-- Structure for view `vw_gratificacao`
--
...
--
-- Structure for view `vw_salarios`
--
...
--
-- Structure for view `vw_tempodeservico`
--
...
ALTER TABLE `beneficio`
  ADD CONSTRAINT `fk_Beneficio_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Remuneracao_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `classe_docente`
--
ALTER TABLE `classe_docente`
  ADD CONSTRAINT `fk_Classe_Docente_Classe1` FOREIGN KEY (`Classe_idClasse`) REFERENCES `classe` (`idClasse`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Classe_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Classe_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `docente`
--
ALTER TABLE `docente`
  ADD CONSTRAINT `fk_Docente_Cidade` FOREIGN KEY (`Cidade_idCidade`) REFERENCES `cidade` (`idCidade`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `funcao_docente`
--
ALTER TABLE `funcao_docente`
  ADD CONSTRAINT `fk_Funcao_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Funcao_Docente_Funcao1` FOREIGN KEY (`Funcao_idFuncao`) REFERENCES `funcao` (`idFuncao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Funcao_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `licenca_docente`
--
ALTER TABLE `licenca_docente`
  ADD CONSTRAINT `fk_Licenca_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Licenca_Docente_Licenca1` FOREIGN KEY (`Licenca_idLicenca`) REFERENCES `licenca` (`idLicenca`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Licenca_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `lotacao_docente`
--
ALTER TABLE `lotacao_docente`
  ADD CONSTRAINT `fk_Lotacao_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Lotacao_Docente_Instituicao1` FOREIGN KEY (`Instituicao_idInstituicao`) REFERENCES `instituicao` (`idInstituicao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Lotacao_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `nivel_docente`
--
ALTER TABLE `nivel_docente`
  ADD CONSTRAINT `fk_Nivel_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Nivel_Docente_Nivel1` FOREIGN KEY (`Nivel_idNivel`) REFERENCES `nivel` (`idNivel`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Nivel_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `titulo_docente`
--
ALTER TABLE `titulo_docente`
  ADD CONSTRAINT `fk_Titulo_Docente_Docente1` FOREIGN KEY (`Docente_idDocente`) REFERENCES `docente` (`idDocente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Titulo_Docente_Titulo1` FOREIGN KEY (`Titulo_idTitulo`) REFERENCES `titulo` (`idTitulo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Titulo_Docente_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
